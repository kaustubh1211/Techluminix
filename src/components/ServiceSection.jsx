...
const ServicesSection = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      image: '/assets/Service/appdev.png',
      bgColor: 'bg-[#F7EFFF]',
    },
    {
      id: 6,
  ...
  return (
    <section className="py-16 mx-auto px-4 lg:px-24 bg-black overflow-hidden">
