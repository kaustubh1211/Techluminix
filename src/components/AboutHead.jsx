    ...
    <section className="min-h-screen relative flex items-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className={`flex flex-col md:flex-row items-center gap-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="w-full md:w-1/2 space-y-6 text-center md:text-left mx-auto md:mx-0">
          ...
          <div className="w-full md:w-1/2 relative mx-auto md:mx-0 max-w-md md:max-w-none">
    ...
    <section className="py-24 bg-gradient-to-b from-black to-[#131316]">
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col items-center gap-16">
          {/* Title section - Always at the top on mobile */}
          ...
          {/* Reordered content for mobile-first layout */}
          <div className="flex flex-col md:flex-row items-center gap-16 w-full">
            {/* Image - Second on desktop, first on mobile (after title) */}
            <div className="w-full md:w-1/2 order-1 md:order-2 relative mx-auto md:mx-0 max-w-md md:max-w-none mb-12 md:mb-0">
            ...
            {/* Text content - First on desktop, third on mobile (after image) */}
            <div className="w-full md:w-1/2 order-2 md:order-1 space-y-8 text-center md:text-left">
              <div className="space-y-6 mx-auto md:mx-0 max-w-lg md:max-w-none">
              ...
              {/* Stats section - vertical on mobile, grid on desktop */}
              <div id="stats-section" className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                {[
