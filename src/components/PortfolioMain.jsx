...
const PortfolioComponent = () => {
  ...
  return (
    <div className="bg-black my-24 text-white py-12 px-4 sm:px-6 lg:px-8">
      {/* Category Filter with enhanced transitions */}
      <div className="flex flex-wrap items-center justify-center mb-8 space-x-2 md:space-x-4">
      ...
      {/* Portfolio Grid with fade transition */}
